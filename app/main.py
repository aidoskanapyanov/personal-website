...
@app.get("/aboutwebsite", response_class=HTMLResponse)
async def aboutwebsite(request: Request):
    return templates.TemplateResponse("/pages/aboutwebsite.html", {"request": request})
